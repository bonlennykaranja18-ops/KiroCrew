        ...
        <SettingsCard>
          {voiceQ.isError ? (
            ...
            <div className="flex flex-wrap items-center gap-2 mb-2">
              ...
              <Btn danger onClick={() => voiceQ.refetch()}>{i18nT('pages.settings.voicePanel.retry')}</Btn>
            </div>
          ) : !voiceQ.isSuccess ? (
                ...
                <>
                  {systemUnavailable && (
                    ...
                    <div className="flex flex-wrap items-center gap-2 mb-2 text-[13px]" data-testid="system-engine-absent">
                      ...
                      <Btn onClick={() => systemVoicesQ.refetch()}>{i18nT('pages.settings.voicePanel.recheck')}</Btn>
                    </div>
                  )}
                  {systemVoicesFailed && (
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      ...
                      <Btn danger onClick={() => systemVoicesQ.refetch()}>{i18nT('pages.settings.voicePanel.recheck')}</Btn>
                    </div>
                  )}
