...
class TestRefreshForkedTemplates:
    ...
    def test_spawn_gate_aborts_on_refresh_failure_or_timeout(
        self, tmp_path: Path, monkeypatch
    ):
    ...
    def test_refresh_records_per_fork_failure_and_continues(
        self, tmp_path: Path, monkeypatch
    ):
        ...
        assert result_a["prompt"] == "file:///stale/prompt.md"
    ...
    def test_refresh_resolves_spec_by_declared_name(self, tmp_path: Path):
        ...
        with _fork_env(tmp_path) as (kiro_dir, prompt):
            ...
            spec = {"name": "my-crew", "prompt": "file:///stale/prompt.md", "mcpServers": {}}
