...
WRAPPED = [
    ...
    "**[OPTIONS: Alpha | Beta]",  # leading wrapper only
    "[OPTIONS: Alpha | Beta]**",  # trailing wrapper only
...
NOT_A_MARKER = [
    ...
    # The trailing tolerance is conditional on a LINE-ANCHORED marker: a
    # mid-line marker keeps the pre-widening grammar, so a wrapped inline
    # mention never loses the closing character of its span (GPT server
    # finding on e0709b843, span f634241daeea).
