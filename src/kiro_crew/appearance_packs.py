...
#: Agent lifecycle states a pack may carry audio for. The same three states the
#: per-crew avatar's own ``sounds`` map keys on, so one pack cue and one preset
#: cue are addressable by the same name.
PACK_SOUND_STATES = ("working", "done", "error")
