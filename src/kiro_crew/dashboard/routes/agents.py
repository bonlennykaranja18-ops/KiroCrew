...
def register(app: web.Application) -> None:
    ...
    # Shared appearance library (packs a crew or the Companion gallery can
    # wear). On the DASHBOARD router, not under /api/apps/crew-companion, so a
    # crew's face does not go blank when that app is disabled.
    #
